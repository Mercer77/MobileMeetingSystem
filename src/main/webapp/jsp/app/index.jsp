                ...
                <tbody>
                    <c:forEach items="${page.list}" var="obj">
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/app/toEdit/${obj.id}" class="layui-btn layui-btn-normal"><i class="layui-icon">&#xe642;</i></a>
                                <a href="${pageContext.request.contextPath}/app/delete/${obj.id}" class="layui-btn layui-btn-danger"><i class="layui-icon">&#xe640;</i></a>
                                <a href="${pageContext.request.contextPath}/app/queryById/${obj.id}" class="layui-btn"><i class="layui-icon">&#xe615;</i></a>
                            </td>
                        </tr>
                    </c:forEach>
                        <tr>
